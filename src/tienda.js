...
function ready() {
  ...
  let cantidadAsignada = document.getElementsByClassName(
  ...
  document
    ...
    .addEventListener("click", comprarClick);
...
function obtenerArticulosLocalStorage() {
  let articuloLS =
    localStorage.getItem("articulos") === null
      ? []
...
function agregarArtAlCarrito(title, price, imageSrc) {
  ...
  let carritoArticulos = document.getElementsByClassName("articulosCarrito")[0];
  let cartItemNames = carritoArticulos.getElementsByClassName(
    "carritoArticuloTitulo"
  );
  ...
  let carritoFilaContenido = `
        ...
        <div class="carritoCantidad carritoColumna">
            <input class="carritoCantidad-input" type="number" value="1">
  ...
  carritoFila
    ...
    .addEventListener("click", eliminaArtCarrito);
  carritoFila
    .getElementsByClassName("carritoCantidad-input")[0]
...
function actualizarTotal() {
  let cartItemContainer =
    document.getElementsByClassName("articulosCarrito")[0];
  ...
  for (let i = 0; i < carritoFilas.length; i++) {
    ...
    let quantityElement = carritoFila.getElementsByClassName(
      "carritoCantidad-input"
    )[0];
